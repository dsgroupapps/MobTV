...
export function HomeRede() {
  ...
  return (
    <section className="relative bg-navy text-off-white py-16 md:py-20 px-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div ref={mapReveal.ref} data-visible={mapReveal.visible} className="reveal-root mt-8 md:mt-10">
          <div className="reveal reveal-1 relative rounded-2xl border border-white/10 bg-[color-mix(in_oklab,var(--navy-soft)_60%,transparent)] p-4 md:p-6 backdrop-blur-sm">
            <CoverageMap />
          </div>
        </div>
